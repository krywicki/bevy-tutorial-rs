...
const PLAYER_SPRITE: &str = "john-head.png";
const LASER_SPIRTE: &str = "laser_a_01.png";
...
fn main() {
    ...
    .insert_resource(WindowDescriptor{
        title: "jvr".into(), // "john-versus-ruskies"
        width: 598.0,
        height: 676.0,
        ..Default::default()
    })
...
fn setup(
    ...
    commands.insert_resource(Materials {
        ...
        laser: materials.add(asset_server.load(LASER_SPIRTE).into())
    });
...
fn player_spawn(mut commands: Commands,
    ...
    commands
        .spawn_bundle(SpriteBundle {
            ...
            transform: Transform {
                translation: Vec3::new(0., bottom + 100. / 2. + 5., 10.),
...
fn player_fire(
    ...
    if let Ok((player_tf, mut ready_fire, _)) = query.single_mut() {
        if ready_fire.0 && kb.pressed(KeyCode::Space) {
            let x = player_tf.translation.x + 20.;
            let y = player_tf.translation.y + 15.;
